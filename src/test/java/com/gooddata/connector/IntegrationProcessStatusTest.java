...
public class IntegrationProcessStatusTest {
    ...
    public void testShouldDeserialize() throws Exception {
        ...
        assertThat(process.getStarted(), is(LocalDateTime.of(2014, 5, 30, 7, 50, 15).atZone(ZoneOffset.UTC)));
        assertThat(process.getFinished(), is(LocalDateTime.of(2014, 5, 30, 7, 50, 50).atZone(ZoneOffset.UTC)));
